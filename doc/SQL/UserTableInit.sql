...
create table t_user (
  ...
  user_name     VARCHAR(30) NOT NULL  UNIQUE             COMMENT '登录用户名',
  ...
  PRIMARY KEY (id),
  INDEX is_delete_index(is_deleted),
  INDEX corporation_index(corporation),
  INDEX user_type_index(user_type(20)),
  UNIQUE INDEX user_name_index(user_name(30)),
  UNIQUE INDEX phone_index(phone(11))
);
