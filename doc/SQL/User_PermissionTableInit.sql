...
## 用户角色关联信息初始化
insert into t_user_permission(corporation, user_id, permission_id, user_permission_type) values (1, 1, 1, "add");
insert into t_user_permission(corporation, user_id, permission_id, user_permission_type) values (1, 2, 2, "sub");
